  ...
  return (
    <main className="min-h-screen bg-background">
      ...
      <section className="flex min-h-[70vh] items-center bg-primary px-4 pb-20 pt-32 text-primary-foreground">
        <div className="mx-auto w-full max-w-3xl rounded-3xl border border-white/15 bg-white/10 p-7 text-center shadow-2xl backdrop-blur-sm sm:p-12">
          <span className="mx-auto flex h-14 w-14 items-center justify-center rounded-full bg-accent text-accent-foreground">
            <FileText className="h-6 w-6" aria-hidden="true" />
          </span>
          <h1 className="mt-6 text-3xl font-light sm:text-5xl">{text[kind]}</h1>
          <p className="mt-5 text-lg text-primary-foreground/75">{text.message}</p>
          <Link
            href="/"
            className="mt-8 inline-flex min-h-11 items-center justify-center rounded-full bg-accent px-6 py-3 font-medium text-accent-foreground transition hover:bg-accent/90"
          >
