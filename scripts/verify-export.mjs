...
assert.ok(pages.get('privacy').includes('Информация скоро появится'), 'Privacy placeholder must be rendered')
assert.ok(pages.get('offer').includes('Информация скоро появится'), 'Public offer placeholder must be rendered')
